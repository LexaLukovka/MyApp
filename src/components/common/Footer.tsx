  ...
  <div className={classes.footer}>
    <div className={classnames(classes.gridContainer, classes.footerWrapper)}>
      ...
      <div className={classes.footerRightWrapper}>
        <Typography className={classes.footerTitle}>MyApp</Typography>
        <Typography variant="subtitle1" className={classes.footerDescription}>
          Права на товарный знак «MyApp» принадлежат ФОП Каунов Иван
        ...
        <div className={classes.footerEmail}>
          ...
          />
          <a
            href="mailto:support@MyApp.online"
            className={classes.footerLink}
          >
            support@MyApp.online
          </a>
        </div>
      </div>
    </div>
    ...
    <div className={classes.footerEnd}>
      <div className={classes.commonFooterEnd}>
        <Typography className={classes.footerEndLink}>MyApp Сopyright © 2017 – 2019</Typography>
        <a href="#">
